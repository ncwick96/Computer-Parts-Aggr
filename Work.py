...
c.execute("INSERT INTO Computer_Parts(Date, Name, Class, Quantity, Model, Manufacturer, Price, Site) "
          "Values(NOW(),'Corsair 64gb RAM 3200','RAM','64','224873','Corsair','550.98','Amazon')")
c.close()
